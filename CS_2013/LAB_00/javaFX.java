...
public class javaFX extends Application {
	...
	RadioButton[] radioButton = { new RadioButton("Red"), new RadioButton("Green"), new RadioButton("Blue"), new RadioButton("Black")};
	...
	public void setUI() {
		...
		hBox[0].getChildren().addAll(new Label("Select Font Style"), comboBox, new Label("Select Font Size"), sizeBox);
		comboBox.getItems().addAll(Font.getFamilies());
		comboBox.setOnAction(this::setFont);
		sizeBox.getItems().addAll(8, 10, 12, 14);
		sizeBox.setOnAction(this::setFontSize);
	...
	public void setPostureWeight(ActionEvent e) {
		...
		if (checkBox[0].isSelected()) {
			...
			if (checkBox[1].isSelected() && checkBox[2].isSelected()) {
			...
			if (!checkBox[0].isSelected() && checkBox[2].isSelected()) {
				
				text.setFont(Font.font((text.getFont()).getName(), FontWeight.NORMAL, FontPosture.ITALIC, text.getFont().getSize()));
	...
	public void setFontSize(ActionEvent e) {
		text.setFont(Font.font(sizeBox.getValue()));
