...
/*	  System.out.println(tree.addRoot("a").getElement());
	  System.out.println(tree.addLeft(tree.root(), "b").getElement());
	  System.out.println(tree.addRight(tree.root(), "c").getElement());
	  System.out.println(tree.addRight(tree.right(tree.root()), "d").getElement());*/
